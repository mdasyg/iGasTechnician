...
<html>
    <head>
		...
		<title><?=$technicians_header?></title>
	...
	<body>
		...
		<div class="header" style="margin-top:-45px;">
			...
			<h4><?php echo $technicians_header.' | <a href="technician_profile.php?user_id=' .$user_id1. '"><button class="exit_button">'.$username.'</button></a> ('.$type1.')</h4></br>';?>			
		</div>
		...
		<div id="tableForm" style="margin-top:-135px;">
			...
			<div class=" plus_icon">
				<a href="technician_add.php"><img src="images/plus.png" width="50" height="50"/><span><?php echo $technicians_add ?></span></a>
			</div>
			...
			<div class="sum_table display" id="example">
				...
				<tbody>
				<?php 
					$sql_show_customers = $dbh->prepare("SELECT * FROM usersili INNER JOIN phonesili ON usersili.user_id=phonesili.usr_id WHERE usersili.type='technician' AND phonesili.type='Σταθερό'");
					...
					{		
						...
						$icon_pass = '<img src="images/pass_change.png" width="39" height="37"/>';

						echo '<td style="width:90px;">';
							echo '<div class="icon_delete">';
								echo '<a onclick="return confirm(\'Είστε σίγουρος για τη διαγραφή;\')" href="technician_delete.php?user_id=' .$user_id. '">'.$icon_delete.'<span>'.$customers_delete.'</span></a>'; 
							echo '</div>';
						echo "</td >";
						echo '<td style="width:90px;">';
						...
						echo '<td style="width:90px;">';
							echo '<div class="icons">';
								echo '&nbsp;&nbsp;<a href="technician_profile.php?user_id=' .$user_id. '">'.$icon_profile.'<span>'.$customers_profile.'</span></a>';
							echo '</div>';
						echo "</td >";
						echo '<td style="width:90px;">';
							echo '<div class="icons">';
								echo '<a href="technician_change_password1.php?user_id=' .$user_id. '">'.$icon_pass.'<span>'.$customers_pass.'</span></a>';
							echo '</div>';
						echo "</td >";
						echo "<td>";	
							echo $row['user_id'];
