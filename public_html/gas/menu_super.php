<?php
	include('errors_warnings.php');
		...
		if((isset($_SESSION['type'])) && ($_SESSION['type'] != "super") || ((!isset($_SESSION['username'])) && (!isset($_SESSION['password'])))){
				...
				<ul id="sti-menu" class="sti-menu" >
					...
					<li data-hovercolor="#ffdd3f">
						<a href="technicians.php">
							<h2 data-type="mText" class="sti-item">'. $menu_technicians.'</h2>
							<h3 data-type="sText" class="sti-item">'. $menu_technicians_text.'</h3>
							<div class="row"><div class="col-xs-offset-3 col-xs-10 col-md-offset-3 col-md-7">	
