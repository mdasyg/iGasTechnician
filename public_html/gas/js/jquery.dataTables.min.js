...
this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Show _MENU_ entries",sZeroRecords:"No matching records found",sInfo:"Εμφανίζονται _START_ με _END_ από τις _TOTAL_ εγγραφές",sInfoEmpty:"Εμφανίζονται 0 με 0 από τις 0 εγγραφές",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sSearch:"Search:",sUrl:"",oPaginate:{sFirst:"First",sPrevious:"Previous",sNext:"Next",sLast:"Last"}};
